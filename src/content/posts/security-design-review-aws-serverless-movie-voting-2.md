---
title: "Security Design Review: AWS Serverless Movie Voting App (2) - CIA Impact and Baseline"
description: How the security-requirements plugin turns a confirmed service profile into a CIA impact rating, a NIST 800-53B baseline, and an ASVS level.
