---
title: "Security Design Review: AWS Serverless Movie Voting App (3) - Threat Analysis"
description: Applying STRIDE at each trust boundary of the AWS serverless movie-rating sample, turning eight threats into eight testable security requirements.
